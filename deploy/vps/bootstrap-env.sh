...
write_key APP_URL https://pilot.giromesa.com.br
write_key CUSTOMER_APP_URL https://menu-pilot.giromesa.com.br
write_key OPS_APP_URL https://app-pilot.giromesa.com.br
write_key API_URL https://api-pilot.giromesa.com.br
write_key NEXT_PUBLIC_API_URL https://api-pilot.giromesa.com.br
write_key NEXT_PUBLIC_OPS_URL https://app-pilot.giromesa.com.br
write_key NEXT_PUBLIC_GOOGLE_AUTH_ENABLED true
write_key NEXT_PUBLIC_WHATSAPP_NUMBER "$whatsapp_number"
write_key NEXT_PUBLIC_CUSTOMER_API_URL https://api-pilot.giromesa.com.br
...
write_key VITE_API_URL https://api-pilot.giromesa.com.br
write_key VITE_SITE_URL https://pilot.giromesa.com.br
write_key VITE_DEMO_MODE false
write_key LOG_LEVEL info
write_key TRUST_PROXY true
write_key CORS_ORIGINS https://pilot.giromesa.com.br,https://menu-pilot.giromesa.com.br,https://app-pilot.giromesa.com.br
...
write_key GOOGLE_OAUTH_REDIRECT_URI https://api-pilot.giromesa.com.br/api/v1/auth/google/callback
