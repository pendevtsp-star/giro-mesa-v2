...
Directory-based community: packages/api-client-csharp/Generated/Api
...
| AuthRequestBuilder | Class | C:\Users\maxue\projetos_programação\giro_mesa_v2\packages\api-client-csharp\Generated\Api\V1\Auth\AuthRequestBuilder.cs | 22-81 |
| AuthRequestBuilder | Function | C:\Users\maxue\projetos_programação\giro_mesa_v2\packages\api-client-csharp\Generated\Api\V1\Auth\AuthRequestBuilder.cs | 78-80 |
...
- `ReferenceEquals` (362 edge(s))
- `nameof` (362 edge(s))
- `IParsable` (182 edge(s))
- `GetStringValue` (175 edge(s))
- `WriteStringValue` (175 edge(s))
- `writer` (163 edge(s))
- `IAdditionalDataHolder` (132 edge(s))
- `WriteAdditionalData` (132 edge(s))
- `n` (121 edge(s))
- `WriteIntValue` (68 edge(s))
- `GetIntValue` (66 edge(s))
- `GetGuidValue` (58 edge(s))
- `WriteGuidValue` (58 edge(s))
- `BaseRequestBuilder` (50 edge(s))
- `IComposedTypeWrapper` (41 edge(s))

### Incoming

- `C:\Users\maxue\projetos_programação\giro_mesa_v2\packages\api-client-csharp\Generated\Api\V1\Organizations\Item\Units\Item\Pilot\Catalog\Products\ProductsPostRequestBody.cs` (8 edge(s))
...
- `C:\Users\maxue\projetos_programação\giro_mesa_v2\packages\api-client-csharp\Generated\Api\V1\Auth\Register\RegisterPostRequestBody.cs::RegisterPostRequestBody_termsAccepted` (3 edge(s))
- `C:\Users\maxue\projetos_programação\giro_mesa_v2\packages\api-client-csharp\Generated\Api\V1\Organizations\Item\Growth\ApiKeys\ApiKeysPostRequestBody.cs::ApiKeysPostRequestBody_expiresAt` (3 edge(s))
