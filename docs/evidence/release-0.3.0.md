...
## Publicação e correção 0.3.1

A versão `0.3.0`, commit `437608f035f98f2c0965242a08a41172d65f879a`, passou no [CI completo](https://github.com/pendevtsp-star/giro-mesa-v2/actions/runs/34256040766), no [Security](https://github.com/pendevtsp-star/giro-mesa-v2/actions/runs/34256040738) e na [publicação assinada target/recovery](https://github.com/pendevtsp-star/giro-mesa-v2/actions/runs/34256777459). O entrypoint confiável concluiu a promoção na VPS, com serviços saudáveis e backup `20260908T175609Z-b172f5f755817af846cab5a19c18d186`; assinatura e hashes dos quatro arquivos do backup foram conferidos.

A migration 0080 está aplicada: o último registro do PostgreSQL tem `created_at=1788829660611`. A conferência pós-deploy detectou somente a constante desatualizada `RELEASE_SCHEMA_VERSION=79` no indicador de saúde da API. A correção `0.3.1` atualiza essa constante para 80 e adiciona um teste que compara o indicador com a última migration do journal; o teste falhou antes da correção e passou depois. O baseline agora referencia o CI aprovado de `437608f0`, com migration `applied`; nenhuma homologação externa é inferida. A tag original `v0.3.0` permanece imutável.
