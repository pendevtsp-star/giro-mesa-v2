...
namespace GiroMesa.ApiClient.V1.Organizations.Item.Growth.DeliveryOrders.Item.Status
{
    ...
    #pragma warning restore CS1591
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::GiroMesa.ApiClient.V1.Organizations.Item.Growth.DeliveryOrders.Item.Status.StatusPatchRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::GiroMesa.ApiClient.V1.Organizations.Item.Growth.DeliveryOrders.Item.Status.StatusPatchRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GiroMesa.ApiClient.V1.Organizations.Item.Growth.DeliveryOrders.Item.Status.StatusPatchRequestBody();
        }
        /// <summary>
