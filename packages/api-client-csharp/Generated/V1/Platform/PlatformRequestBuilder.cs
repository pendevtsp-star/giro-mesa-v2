...
using System;
namespace GiroMesa.ApiClient.V1.Platform
{
    /// <summary>
    /// Builds and executes requests for operations under \v1\platform
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class PlatformRequestBuilder : BaseRequestBuilder
    {
        /// <summary>The commercial property</summary>
        public global::GiroMesa.ApiClient.V1.Platform.Commercial.CommercialRequestBuilder Commercial
        {
            get => new global::GiroMesa.ApiClient.V1.Platform.Commercial.CommercialRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The fiscal property</summary>
        public global::GiroMesa.ApiClient.V1.Platform.Fiscal.FiscalRequestBuilder Fiscal
        {
            get => new global::GiroMesa.ApiClient.V1.Platform.Fiscal.FiscalRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The incidents property</summary>
        public global::GiroMesa.ApiClient.V1.Platform.Incidents.IncidentsRequestBuilder Incidents
        {
        ...
        {
            get => new global::GiroMesa.ApiClient.V1.Platform.Outbox.OutboxRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        {
            get => new global::GiroMesa.ApiClient.V1.Platform.Tenants.TenantsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::GiroMesa.ApiClient.V1.Platform.PlatformRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PlatformRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/platform", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::GiroMesa.ApiClient.V1.Platform.PlatformRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PlatformRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/platform", rawUrl)
        {
        }
    }
}
